...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_f1 << dot(v) == (-2.00000000000000004163e-02*v*v+u)/m;
    acadodata_f1 << dot(m) == (-1.00000000000000002082e-02)*u*u;
    acadodata_f1 << dot(L) == u*u;

    OCP ocp1(0, 10, 20);
    ocp1.minimizeMayerTerm(L);
    ocp1.subjectTo(acadodata_f1);
    ocp1.subjectTo(AT_START, s == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, v == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, L == 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, m == 1.00000000000000000000e+00);
    ocp1.subjectTo(AT_END, s == 1.00000000000000000000e+01);
    ocp1.subjectTo(AT_END, v == 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000002082e-02) <= v <= 1.30000000000000004441e+00);


    OptimizationAlgorithm algo1(ocp1);
    algo1.set( KKT.TOLERANCE, 1.000000E-10 );
