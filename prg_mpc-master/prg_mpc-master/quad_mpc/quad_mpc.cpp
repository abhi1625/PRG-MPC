...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "Quad_MPC_data_acadodata_M1.txt" );
    ...
    acadodata_M2.read( "Quad_MPC_data_acadodata_M2.txt" );
    ...
    DynamicSystem dynamicsystem2( acadodata_f1,acadodata_f4 );
    Process process3( dynamicsystem2,INT_RK45 );

    SimulationEnvironment algo2(0, 5, process3, controller1);
